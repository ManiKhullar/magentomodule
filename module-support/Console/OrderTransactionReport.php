...
class OrderTransactionReport extends Command
{
    const NAME = 'sales:order:OrderTransactionReport';

    const INTERVAL = 'altayer_order_monitor/report_order/inerval_day';
    ...
    protected function configure()
    {
        ...
        $this->setDescription('Order Transaction Report Information');
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->exportCsvFile($startDate,$endDate);
     ...
     * @param $endDate
     */
    protected function exportCsvFile($startDate, $endDate)
    {
        try{
